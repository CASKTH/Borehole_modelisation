...
# @named ODE_Disc_var = VariableCurrent_evolve_var_pins_2(4,1, timer_)
@named simple_layers = soil_n_var_simple(6, timer_; Rp=1.0, Cp=1.0, T_soil = 20)
# @named wall_layers = soil_n_var_layer(4, timer_; Rp=1.0, Cp=1.0, T_soil = 20)
...
sys_2 = structural_simplify(simple_layers)
timer_= 86400
...
@nonamespace u0= [
    ...
    # sys_2.layer_0₊soil₊C1₊v => T_soil,
    # sys_2.layer_0₊cap_joint_3₊v=> T_soil,

    # sys_2.layer_0₊grout_2₊C1₊v => T_grout,
    # sys_2.layer_0₊grout_2₊capacitor_0₊v =>T_grout,
    # sys_2.layer_0₊grout_1₊capacitor_0₊v =>T_grout,
    # sys_2.layer_0₊grout_1₊C1₊v =>T_grout,
    
    # sys_2.layer_0₊grout_grout₊capacitor_0₊v => T_grout,
    # sys_2.layer_0₊grout_grout₊C1₊v => T_grout,
    # sys_2.layer_0₊fluid_1₊capacitor_0₊v => T_fluid,
    # sys_2.layer_0₊fluid_1₊C1₊v => T_fluid,

    # sys_2.layer_0₊fluid_2₊capacitor_0₊v => T_fluid,
    # sys_2.layer_0₊fluid_2₊C1₊v => T_fluid,

    # sys_2.layer_0₊pipe_1₊capacitor_0₊v => T_grout,
    # sys_2.layer_0₊pipe_2₊capacitor_0₊v => T_grout,

    # sys_2.layer_0₊cap_joint_1₊v=> T_grout,
    # sys_2.layer_0₊cap_joint_2₊v=> T_grout,
...
obj = lines!(x, solu[1]; color = solu[1], label ="t=$(1)", colormap = :heat, linewidth = 1)
...
# colgap!(fig.layout, 10)
>>>>>>> 5ce13351c39ef8d189650c1282416b9190f6907c
fig